...
#include <sys/types.h>
#include <sys/wait.h>
#define FILE "task10_part1_new_process" // путь к исполняемому файлу, который необходимо запустить в качестве порожденного процесса
void main()
{
    ...
    {
        printf("\nОшибка создания нового процесса.\n");
    }
    ...
    {
    printf("Создан процесс с PID = %d\n", pid_new_process);
    printf("Ждем завершения порожденного процесса...\n");
